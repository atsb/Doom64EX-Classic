...
static void AddSegToDrawlist(drawlist_t *dl, seg_t *line, int texid, int sidetype) {
    ...
    switch(sidetype) {
    case 0:
        list->callback = (dboolean (*)(void *, vtx_t *))R_GenerateLowerSegPlane;
        break;
    case 1:
        list->callback = (dboolean (*)(void *, vtx_t *))R_GenerateUpperSegPlane;
        break;
    case 2:
        list->callback = (dboolean (*)(void *, vtx_t *))R_GenerateMiddleSegPlane;
        break;
    case 3:
        list->callback = (dboolean (*)(void *, vtx_t *))R_GenerateSwitchPlane;
        break;
    default:
        return;
    }
